...
def replace_instances(player_entries, filename):
    ...
    summoned_pet_names = {"Greater Feral Spirit", "Battle Chicken", "Arcanite Dragonling", "The Lost", "Minor Arcane Elemental", "Scytheclaw Pureborn", "Explosive Trap I", "Explosive Trap II", "Explosive Trap III", "Sproutling", "Spirit Protector", "Hellfire Imp", "Infernal", "Doomguard", "Felguard"}
